...
public class Ui {
    ...
    public static void configTopBar(Activity activity, String rightNote) {
        ...
        top_bar_menu_root_vip.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                top_bar_menu_root_vip.setBackground(activity.getResources().getDrawable(R.drawable.bg_vip_menu_focus));
                ...
                top_bar_menu_root_vip.setBackground(activity.getResources().getDrawable(R.drawable.bg_vip_menu_normal));
