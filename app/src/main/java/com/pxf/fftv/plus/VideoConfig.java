...
public class VideoConfig {
    ...
    // 改为从CMS后台获取
    // public static final String WEIDUO_ANALYSIS_PLAY_URL = "http://k377.cc/json/?url=";
    ...
    public static class VideoScreen implements Serializable {
        ...
        public VideoScreen(String title, String baseUrl, VideoScreenSub[] types, VideoScreenSub[] years, VideoScreenSub[] acts, VideoScreenSub[] languages, VideoScreenSub[] areas, VideoScreenSub[] ranks) {
            this.title = title;
    ...
    public static final VideoScreenSub[] VIDEO_SCREEN_CMS_YEAR = new VideoScreenSub[]{
    ...
    public static final VideoScreen[] VIDEO_SCREEN_CMS = new VideoScreen[]{
            new VideoScreen(
                    "电影", BASE_CMS_URL,
                    new VideoScreenSub[]{
                            new VideoScreenSub("全部", "&t=1"),
                            new VideoScreenSub("动作", "&t=6"),
                            new VideoScreenSub("喜剧", "&t=7"),
                            new VideoScreenSub("爱情", "&t=8"),
                            new VideoScreenSub("科幻", "&t=9"),
                            new VideoScreenSub("恐怖", "&t=10"),
                            new VideoScreenSub("剧情", "&t=11"),
                            new VideoScreenSub("战争", "&t=12")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
            ...
            new VideoScreen(
                    ...
                    new VideoScreenSub[]{
                            ...
                            new VideoScreenSub("国产剧", "&t=13"),
                            new VideoScreenSub("港剧", "&t=14"),
                            new VideoScreenSub("日剧", "&t=15"),
                            new VideoScreenSub("美剧", "&t=16"),
                            new VideoScreenSub("台湾剧", "&t=20"),
                            new VideoScreenSub("韩剧", "&t=21")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
            ...
            new VideoScreen(
                    ...
                    new VideoScreenSub[]{
                            ...
                            new VideoScreenSub("大陆综艺", "&t=22"),
                            new VideoScreenSub("港台综艺", "&t=23"),
                            new VideoScreenSub("日韩综艺", "&t=24"),
                            new VideoScreenSub("欧美综艺", "&t=25"),
                            new VideoScreenSub("其他综艺", "&t=30")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
            ...
            new VideoScreen(
                    ...
                    new VideoScreenSub[]{
                            ...
                            new VideoScreenSub("大陆动漫", "&t=26"),
                            new VideoScreenSub("港台动漫", "&t=27"),
                            new VideoScreenSub("日韩动漫", "&t=28"),
                            new VideoScreenSub("欧美动漫", "&t=29"),
                            new VideoScreenSub("其他动漫", "&t=31")
                    },
                    VIDEO_SCREEN_CMS_YEAR,
                    new VideoScreenSub[]{},
                    VIDEO_SCREEN_CMS_LANG,
