    ...
    public ArrayList<Video> getVideos(Const.VideoType type, int page) {
        ...
        switch (type) {
            ...
            case TELEPLAY_JAPAN:
                ...
                break;
            case TELEPLAY_KOREA:
                url = BASE_URL + "&t=21&pg=" + page;
                break;
            case TELEPLAY_OTHER:
                url = BASE_URL + "&t=20&pg=" + page;
                break;
            case TELEPLAY_TAIWAN:
                url = BASE_URL + "&t=22&pg=" + page;
                break;
            ...
            // 动漫
            case CARTOON_LATEST:
                url = BASE_URL + "&t=24&pg=" + page;
                break;
            case CARTOON_EA:
                url = BASE_URL + "&t=24&pg=" + page;
                break;
            case CARTOON_JK:
                url = BASE_URL + "&t=23&pg=" + page;
                break;
            case CARTOON_CHINA:
                url = BASE_URL + "&t=25&pg=" + page;
                break;
            case CARTOON_OTHER:
